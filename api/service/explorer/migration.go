...
func (m *migrationV100) doMigration() error {
	err := m.forEachLegacyAddressInfo(func(addr addrStr, addrInfo *Address) error {
...
func (m *migrationV100) forEachLegacyAddressInfo(f func(addr addrStr, addrInfo *Address) error) error {
	...
	for it.Next() {
		...
		addr := addrStr(key[legAddressPrefixLen:])
...
func (m *migrationV100) migrateLegacyAddressToBatch(addr addrStr, addrInfo *Address) error {
...
func (m *migrationV100) migrateLegacyNormalTx(addr addrStr, legTx *LegTxRecord) error {
...
func (m *migrationV100) migrateLegacyStakingTx(addr addrStr, legTx *LegTxRecord) error {
	txHash := common.HexToHash(legTx.Hash)
	_, bn, index := m.bc.ReadTxLookupEntry(txHash)
...
func (m *migrationV100) checkMigratedAddress(addr addrStr, addrInfo *Address) error {
	if addr == "" {
