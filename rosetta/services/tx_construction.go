...
type TransactionMetadata struct {
	...
	Logs                      []*astraTypes.Log          `json:"logs,omitempty"`
...
) (response astraTypes.PoolTransaction, rosettaError *types.Error) {
...
func constructCrossShardTransaction(
	components *OperationComponents, metadata *ConstructMetadata, sourceShardID uint32,
) (astraTypes.PoolTransaction, *types.Error) {
	...
	return astraTypes.NewCrossShardTransaction(
...
func constructContractCreationTransaction(
	...
	return astraTypes.NewContractCreation(
...
func constructPlainTransaction(
	...
	return astraTypes.NewTransaction(
