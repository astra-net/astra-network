...
func applyGeneralFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyDNSSyncFlags(cmd *cobra.Command, cfg *astraconfig.AstraConfig) {
...
func applyNetworkFlags(cmd *cobra.Command, cfg *astraconfig.AstraConfig) {
...
var (
	...
	p2pKeyFileFlag = cli.StringFlag{
		Name:     "p2p.keyfile",
		Usage:    "the p2p key file of the astra node",
...
func applyP2PFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyHTTPFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyWSFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyRPCOptFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyBLSFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyBLSPassFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyKMSFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyLegacyBLSPassFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyLegacyKMSFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func legacyApplyBLSPassVal(src string, config *astraconfig.AstraConfig) {
...
func legacyApplyKMSSourceVal(src string, config *astraconfig.AstraConfig) {
	methodArgs := strings.SplitN(src, ":", 2)
	method := methodArgs[0]
...
func applyConsensusFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyTxPoolFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyPprofFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
	var pprofSet bool
...
var (
	...
	logFileNameFlag = cli.StringFlag{
		Name:     "log.name",
		Usage:    "log file name (e.g. astra.log)",
...
func applyLogFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
	...
	if cli.IsFlagChanged(cmd, logVerbosePrintsFlag) {
		...
		config.Log.VerbosePrints = astraconfig.FlagSliceToLogVerbosePrints(verbosePrintsFlagSlice)
	}
...
func applySysFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyDevnetFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyRevertFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyLegacyMiscFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
	...
	if cli.HasFlagsChanged(cmd, []cli.Flag{legacyWebHookConfigFlag, legacyTPBroadcastInvalidTxFlag}) {
		config.Legacy = &astraconfig.LegacyConfig{}
...
func applyPrometheusFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applySyncFlags(cmd *cobra.Command, config *astraconfig.AstraConfig) {
...
func applyShardDataFlags(cmd *cobra.Command, cfg *astraconfig.AstraConfig) {
