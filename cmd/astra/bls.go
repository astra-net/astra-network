...
func setupConsensusKeys(hc astraconfig.AstraConfig, config *nodeconfig.ConfigType) multibls.PublicKeys {
...
func loadBLSKeys(raw astraconfig.BlsConfig) (multibls.PrivateKeys, error) {
...
func parseBLSLoadingConfig(raw astraconfig.BlsConfig) (blsgen.Config, error) {
	var (
...
func parseBLSPassConfig(cfg blsgen.Config, raw astraconfig.BlsConfig) (blsgen.Config, error) {
	if !raw.PassEnabled {
...
func parseBLSKmsConfig(cfg blsgen.Config, raw astraconfig.BlsConfig) (blsgen.Config, error) {
	if !raw.KMSEnabled {
